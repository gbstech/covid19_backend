...
class IsActiveUser(APIView):
    ...
    def patch(self,request, *args, **kwargs):
        ...
        try:
            ...
            return Response({'status':False ,'message':'user status update fail'},status=status.HTTP_501_NOT_IMPLEMENTED)
...
class UpdateUserRole(APIView):
    ...
    def patch(self,request, *args, **kwargs):
        ...
        try:
            ...
            return Response({'status':False ,'message':'user role update fail'},status=status.HTTP_501_NOT_IMPLEMENTED)