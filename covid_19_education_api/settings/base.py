"""
Django settings for covid_19_education_api project.
...
SECRET_KEY = env('DJANGO_SECRET_KEY', default='nt5d7ykxxo@5d19#0=rafzfkxafr%7_)+(!@lx(cp^zesh#bid')
...
ROOT_URLCONF = 'covid_19_education_api.urls'
...
WSGI_APPLICATION = 'covid_19_education_api.wsgi.application'
